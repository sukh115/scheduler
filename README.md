# scheduler
### Spring Boot 기반의 간단한 일정 관리 웹 API입니다.  
### 작성자 정보를 등록하고, 각 작성자가 일정을 생성/조회/수정/삭제할 수 있습니다.
...
| 일정 페이징 조회     | GET  | `/schedules/paged?page=0&size=10` | -              | ```json[ { "title": "회의", "content": "팀 미팅", "updatedDate": "2025-03-20", "name": "홍길동" } ]``` | 200 OK / 빈 배열 |
